...
export default {
  ...
  methods: {
    ...
    shareFc() {
      ...
      // const dpr = uni.getSystemInfoSync().pixelRatio || 1; // 获取设备的devicePixelRatio
      // console.log('ctx',ctx.value.wid);
      ...
      query
        ...
        .exec(res => {
          ...
          const ctx = uni.createCanvasContext('default_PosterCanvasId', this);
          ...
          // this.showShare(this.avatarImage);
          ctx.scale(dpr, dpr);
          ctx.draw();
      ...
      // this.poster.width = IMG_REAL_W * dpr;
      // this.poster.height = IMG_REAL_H * dpr;
      // console.log('ctx', ctx);
      // // 缩放Canvas上下文
      // ctx.scale(dpr, dpr);
